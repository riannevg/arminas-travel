...
<div class="col-3_sm-4_xs-6 padded-1">
    <a href="/hotels/oriundo">
        <div class="bg-image square" style="background-image:url('/images/hotels/oriundo/oriundo1.jpg')"></div>
        <h3 class='center'>Oriundo Luxury Nature Villas </h3>        
    </a>  
</div>
...
<div class="col-3_sm-4_xs-6 padded-1">
    <a href="/hotels/mesonmarques">
        <div class="bg-image square" style="background-image:url('/images/hotels/mesonmarques/mesonmarques5.jpg')">  </div>
        <h3 class='center'>Meson del Marques</h3>
        <p class='center'>Valladolid</p>        
    </a>  
</div>
